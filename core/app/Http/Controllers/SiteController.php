...
class SiteController extends Controller {
    ...
    public function blogDetails($slug) {
        ...
        $sharebuttons2 = \ShareButtons::page(url()->current(), $dataValues->title, [
            'title' => $dataValues->title,
            'rel' => 'nofollow noopener noreferrer',
        ])
            ->blogger(['title' => 'blogger'])
            ->diigo(['title' => 'diigo'])
            ->draugiem(['title' => 'draugiem'])
            ->copylink(['title' => 'copylink'])
            ->evernote(['title' => 'evernote'])
            ->facebook(['title' => 'facebook'])
            ->flipboard(['title' => 'flipboard'])
            ->google_classroom(['title' => 'google_classroom'])
            ->hackernews(['title' => 'hackernews'])
            ->linkedin(['title' => 'linkedin', 'rel' => 'follow'])
        ...
        return view('Template::blog_details', compact('blog', 'pageTitle', 'seoContents', 'seoImage', 'latestBlogs', 'mostViews', 'sharebuttons2'));
    }
