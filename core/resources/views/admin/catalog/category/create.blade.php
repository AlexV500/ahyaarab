...
@section('panel')
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.catalog.category.store') }}" method="POST" class="disableSubmission" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="form-group">
                                    <label>@lang('Category Image')</label>
                                    <x-image-uploader class="w-100" :imagePath="frontendImage('',@$data->image,getFileSize('category'),true)" :size="getFileSize('category')" :required="false" />
                                </div>
                            </div>
