    ...
    <section class="pt-120 pb-120 section--bg">
        <div class="container">
            <div class="row justify-content-center mb-none-30">
                                                ...
                                                <div class="payment-system-list p-3">
                                                    <div class="deposit-info">
                                                        ...
                                                        <div class="deposit-info__input">
                                                             <p class="text"><span class="amount">{{ cart()->amount() }}</span>
                                                             </p>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    ...
                                                    <button type="submit" class="cmn-btn w-100 mt-3" disabled>@lang('Confirm Order')</button>
                ...
                <div class="row justify-content-center pt-5 mb-none-30">
                    <!-- Section heading -->
                    ...
                    <div class="order-table">
                        ...
                        <table class="style--two mb-0 table table-condensed"
                               style="">
                            <thead class="text-[12px] text-body uppercase">
                            <th width="90%" scope="col" class="">Item</th>
                            <th width="10%" scope="col" class="">Amount</th>
                            </thead>
                            <tbody>
...
@push('script')
    <script>
        ...
        //    var amount = parseFloat($('.amount') || 0);
            var amount = parseFloat($('.amount')[0].innerHTML || 0);
            calculation();
            console.log(amount);
