...
@section('content')
    <script src="{{ asset('assets/global/js/share.js') }}"></script>
    <script src="{{ asset('assets/global/js/share-buttons.js') }}"></script>
    <script src="{{ asset('assets/global/js/share-buttons.jquery.js') }}"></script>
    <link rel="stylesheet" href="{{ asset('assets/global/css/share-buttons.css') }}">
                                ...
                                @foreach ($latestBlogs as $blog)
                                    <li class="small-post">
                                        ...
                                        <div class="small-post__content">
                                            <h6>
                                                <a href="{{ route('blog.details', slug(@$blog->data_values->title)) }}">{{ __(@$blog->data_values->title) }}</a>
                                            </h6>
                                            <a class="date" href="{{ route('blog.details', slug(@$blog->data_values->title)) }}">{{ showDateTime($blog->created_at) }}</a>
                                        </div>
                                    </li>
                                @endforeach
                            </ul>
