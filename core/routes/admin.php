...
Route::middleware('admin')->group(function () {
    Route::controller('AdminController')->group(function () {
        ...
        Route::get('addprofile', 'addprofile')->name('addprofile');
        Route::post('addprofile', 'storeProfile')->name('profile.add');

        Route::get('otherprofile/{id}', 'otherProfile')->name('otherprofile');
        Route::post('otherprofile/{id}', 'otherProfileUpdate')->name('otherprofile.update');
    ...
    Route::group(['namespace' => 'Catalog', 'prefix' => 'catalog'], function () {
        ...
        Route::group(['namespace' => 'Category', 'prefix' => 'category'], function () {
            Route::get('/', 'IndexController')->name('catalog.category.index');
            Route::get('create', 'CreateController')->name('catalog.category.create');
            Route::post('/', 'StoreController')->name('catalog.category.store');
            Route::get('edit/{category}', 'EditController')->name('catalog.category.edit');
            Route::patch('/{category}', 'UpdateController')->name('catalog.category.update');
            Route::post('/{category}', 'DeleteController')->name('catalog.category.delete');
            Route::get('positionUp/{category}', 'PositionUpController')->name('catalog.category.positionUp');
            Route::get('positionDown/{category}', 'PositionDownController')->name('catalog.category.positionDown');
        });

        Route::group(['namespace' => 'Product', 'prefix' => 'product'], function () {
            Route::get('/', 'IndexController')->name('catalog.product.index');
            Route::get('create', 'CreateController')->name('catalog.product.create');
            Route::post('/', 'StoreController')->name('catalog.product.store');
            Route::get('edit/{product}', 'EditController')->name('catalog.product.edit');
            Route::patch('/{product}', 'UpdateController')->name('catalog.product.update');
            Route::post('/{product}', 'DeleteController')->name('catalog.product.delete');
            Route::get('positionUp/{product}', 'PositionUpController')->name('catalog.product.positionUp');
            Route::get('positionDown/{product}', 'PositionDownController')->name('catalog.product.positionDown');
        });

        Route::group(['namespace' => 'Property', 'prefix' => 'property'], function () {
            Route::get('/', 'IndexController')->name('catalog.property.index');
            Route::get('create', 'CreateController')->name('catalog.property.create');
            Route::post('/', 'StoreController')->name('catalog.property.store');
            Route::get('edit/{property}', 'EditController')->name('catalog.property.edit');
            Route::patch('/{property}', 'UpdateController')->name('catalog.property.update');
            Route::post('/{property}', 'DeleteController')->name('catalog.property.delete');
            Route::get('positionUp/{category}', 'PositionUpController')->name('catalog.property.positionUp');
            Route::get('positionDown/{category}', 'PositionDownController')->name('catalog.property.positionDown');
        });
    });

    Route::get('/admin/catalog/helper/check_catalog_slug', function() {
        return check_catalog_slug();
    });
